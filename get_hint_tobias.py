...
####################################
def top1500(name, dirs,tobias_bed_name,tobias_top1500_bed_path):
    d = dirs
    file = open(tobias_bed_name)
    da = file.readlines()
    file.close()
    new_name = tobias_top1500_bed_path+ '/top1500' + name + '.bed'  # path/tobias_top1500_bed/top1500GSE.bed
    ...
    l = len(line)
    return l
def top1500_1(name, dirs,tobias_top1500_bed_path):
    name =  tobias_top1500_bed_path+'/top1500' + name + '.bed'
    d = dirs
    file = open(name)
    da = file.readlines()
    file.close()
...
#step5 Obtaining TOBIAS top1500 footprint bed files
    ...
    d='5' #variable
    l = top1500(name, d,tobias_bed_name,tobias_top1500_bed_path)
    k = 1
    while l > 1510 or l < 1490:
        if l > 1510:
            a = (l - 1500) / 2000
            if a > 0.05:
                if a > 1:
                ...
                d = str(float(d) + 0.01)
            l = top1500_1(name, d,tobias_top1500_bed_path)
        else:
            a = (1500 - l) / 1500
            if a > 0.05:
                if a > 0.5:
        ...
        if k > 30:
            break
    tobias_top1500_bed_name=tobias_top1500_bed_path+'/top1500' + name + '.bed'
...
################################################
    ...
    #get _pre_hint_tobias.bed  path/pre_hint_tobias/GSE_pre_hint_tobias.bed
    ...
    #get _sort_hint_tobias.bed  path/sort_hint_tobias/GSE_sort_hint_tobias.bed
